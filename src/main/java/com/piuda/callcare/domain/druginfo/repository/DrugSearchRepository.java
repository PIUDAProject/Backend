...
public interface DrugSearchRepository extends ElasticsearchRepository<DrugDocument, String> {
     ...
     * <ul>
     *   <li>term(itemName.keyword)                 : 이름 전체 완전 일치 — 최우선 (boost 20)</li>
     *   <li>match_phrase_prefix(itemName)          : "입력한 그대로 시작" — 강한 신호 (boost 5)</li>
     ...
     *   <li>match_phrase_prefix(itemNameChosung)   : 초성 검색 — 초성이 아니면 매칭 0이라 항상 포함해도 무해 (boost 3)</li>
     * </ul>
    ...
    @Query("""
            {
              "bool": {
                ...
                "should": [
                  { "term": { "itemName.keyword": { "value": "?0", "boost": 20.0 } } },
                  ...
                  { "match_phrase_prefix": { "itemNameChosung": { "query": "?0", "boost": 3.0 } } }
                ]
              }
            }
            """)
